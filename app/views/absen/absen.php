                                            ...
                                            <td class="align-middle text-center text-dark ">
                                                <div class="d-flex justify-content-sm-center mt-2">
                                                    <input type="image" src="tombol/btnmata.png" name="button"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#editmodal<?= $item['id'] ?>" width="50"
                                                        height="37" alt="submit" />
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="absensiswa/update" method="post">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="recipient-name"
                                                                                class="col-form-label">Hadir/Tidak
                                                                                Hadir:</label>
                                                                            <select class="form-select" id="absen"
                                                                                required name="absen"
                                                                                style="background-color: #B6BDFF">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" data-bs-dismiss="modal" aria-label="Close"> <img
                                    src="assets_baru/img/menu/imgclose.svg" alt="" srcset=""> </button>
                        </div>
                        <div class="modal-body">
                            <form action="absensiswa/insert" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" placeholder="Masukkan Tanggal Lahir"
                                        name="tanggal" id="tanggal" required style="background-color: #B6BDFF">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="absen" name="absen"
                                        style="background-color: #B6BDFF">
                                        <option selected>Pilih Absen</option>
                                        <option value="1">Hadir</option>
                                        <option value="0">Tidak Hadir</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Keterangan" name="keterangan"
                                        id="keterangan" required style="background-color: #B6BDFF">
                                </div>
