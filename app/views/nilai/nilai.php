                            ...
                            <div class="container">
                                <div class="row">
                                        ...
                                        <form action="<?= base_url ?>/nilaisiswa/carikelas" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-sm" style="padding-bottom: 5px;">
                                                    <select class="form-select" type="text" class="" name="cari"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm" style="padding-bottom: 5px;">
                                                    ...
                                                    <input type="date" class="form-control" name="tanggal"
                                                        style="background-color:#b0c4ee;padding-left: 8px;" required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <form action="<?= base_url ?>/nilaisiswa/nilai_pdf" method="post"
                                                target="_blank">
                                                <?php 
                                                ...
                                                <button type="submit" class="btn btn-warning" style="width: 380px;">
                                                    <img src="<?= base_url ?>/assets_baru/img/illustrations/pdf-btn.png"
                                                        alt="Kegiatan" width="40" height="40"> CETAK NILAI SESUAI
                                                    TANGGAL
                                                    YANG
                                                    DITENTUKAN
                                                </button>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center text-dark" style="border-right:1pt solid black;">
                                                ...
                                                <a href="<?= base_url ?>/nilaisiswa/delete/<?= $item['id'] ?>"
                                                    type="submit" class="btn btn-xs bg-gradient-danger"
                                                    onclick="return confirm('Apakah anda akan menghapus data ?')">
                                                    <img src="assets_baru/img/illustrations/delete-btn.png" alt=""
                                                        width="20" height="20" />
                                                </a>
                                            </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <button class="buttonclosemodal" type="button" data-bs-dismiss="modal"
                                    aria-label="Close">
                                ...
                                <form action="nilaisiswa/insert" method="POST">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <select class="form-select" id="biodata_siswa_id"
                                                    name="biodata_siswa_id"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="mobileforminput" name="bermain" id="bermain"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="mobileforminput" name="ikrar_bersama"
                                                    id="ikrar_bersama" required
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="mobileforminput" name="senam_irama"
                                                    id="senam_irama" required
                                                    style="width: 250px;background-color: #FFFFFF">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="mobileforminput" name="bernyanyi"
                                                    id="bernyanyi" required
                                                    style="width: 250px;background-color: #FFFFFF">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="mobileforminput" name="berdoa" id="berdoa"
                                                    required style="width: 250px;background-color: #FFFFFF">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="mobileforminput"
                                                    name="pijakan_sebelum_bermain" id="pijakan_sebelum_bermain" required
                                                    style="width: 250px;background-color: #FFFFFF">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="text" class="mobileforminput"
                                                    name="pijakan_setelah_bermain" id="pijakan_setelah_bermain" required
                                                    style="width: 250px;background-color: #FFFFFF">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <input type="date" class="mobileforminput" name="tanggal" id="tanggal"
                                                    required style="width: 250px;background-color: #FFFFFF">
                                            </div>
                                        </div>
