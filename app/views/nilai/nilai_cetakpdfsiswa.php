...
<body>
    ...
    <div class="judul">
        ...
        <center>
            <div style="margin-left: 150px;">
                ...
                <p style=" font-weight: bold;text-transform:uppercase; font-size:small">KELAS : <?= $data['nilai'][0]['kelas'] ?>
                </p>
    ...
    <div id="flex" class="absolute">
        <table id="tabel1" style="border: 0ch">
            ...
            <tr id="tabel1">
                <td id="tabel1">Orang Tua Murid <br><br><br><br><br><br></td>
            </tr>
            <tr>
                <td id="tabel1" style="text-align: center">(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)</td>
            </tr>
        </table>
