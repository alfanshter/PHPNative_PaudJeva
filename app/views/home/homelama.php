...
<div class="content mt-5"
    style="background-image: url(<?= base_url; ?>/img/tampilanawal.jpg);   height: 100%;    background-position: center;    background-repeat: no-repeat;    background-size: cover;">
                            ...
                            <div class="container">
                                <table class="table table-stripped">
                                    ...
                                    <tbody>
                                        ...
                                        <form
                                            action="<?= base_url; ?>/jadwalkegiatansiswa/deletejadwal/<?= $jadwal['id_jadwal']; ?>"
                                            method="POST">
                                            <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?= base_url; ?>/jadwalkegiatansiswa/tambah_jadwal" method="POST"
                    enctype="multipart/form-data">
                    <div class="input-group input-group-sm mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-sm">Jadwal</span>
                        <input required type="text" id="jadwal" name="jadwal" class="form-control"
                            aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                    </div>
                    <div class="input-group input-group-sm mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-sm">Nama Kegiatan</span>
                        <textarea required class="form-control" id="nama_kegiatan" name="nama_kegiatan"
