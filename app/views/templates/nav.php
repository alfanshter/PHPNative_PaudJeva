<nav style="background-color:#f133ff;" class="navbar navbar-main navbar-expand-lg px-0 shadow-none" id="navbarBlur"
    navbar-scroll="true">
            ...
            <?php if($_SESSION['role']==1) {?>    
                <li class="nav-item d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3"
                        aria-labelledby="dropdownMenuButton" style="margin-right: 100px;background-color:#DA2FE9">
                       <div class="d-flex py-2" style="margin-right: 10px;">
                                    <div class="my-auto">
                                        <img src="<?= base_url; ?>/menu/logowa.svg"
